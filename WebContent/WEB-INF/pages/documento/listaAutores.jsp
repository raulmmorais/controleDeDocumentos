...
<div class="row">
	...
	<div class="col-md-4 text-left">Nome</div>
	<div class="col-md-2 text-left">ID</div>
	<div class="col-md-5 text-left">Nome e id</div>
</div>
<s:iterator value="autores">
	<div class="row">
		<div class="col-md-1 text-center" id="id_<s:property value="codigo"/>"><s:property value="id"/></div>
		<div class="col-md-3 text-left" id="nome_<s:property value="codigo"/>"><s:property value="descricao"/></div>
		<div class="col-md-2 text-left" id="codigo_<s:property value="codigo"/>"><s:property value="codigo"/></div>
		<div class="col-md-5 text-left" id="nome_id_<s:property value="codigo"/>"><s:property value="descricao"/>_ID-<s:property value="codigo"/></div>
