...
<h1 class="text-center">Tipo de Documento</h1>
<div class="row">
	<div class="col-md-1 text-center">id</div>
	<div class="col-md-7 text-left">Descri&ccedil;&atilde;o</div>
	<div class="col-md-3 text-left">Cigla</div>
</div>
<s:iterator value="tipoDocumentos">
	<div class="row">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form action="gravarNaturezaDocumento">
			<input type="hidden" name="tipoDocumentoVO.id">
			<div class="form-group">
				<label for="descricao">Descri&ccedil;&atilde;o</label>
				<input type="text" id="descricao" class="form-control" name="tipoDocumentoVO.descricao">
			</div>
			<div class="form-group">
				<label for="codigo">Cigla</label>
				<input type="text" id="codigo" class="form-control" name="tipoDocumentoVO.codigo">
			</div>
		</form>
      </div>
